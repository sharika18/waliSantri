        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
           <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  ...
                  <a href="<?php echo base_url()?>Biaya?act=Tambah" class="nav-link">
                ...
                <li class="nav-item">
                  <!--contoh href biaya adalah controler, modul master biaya adalah view-->
                  <a href="<?php echo base_url()?>BiayaDetail?act=Tambah" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Biaya Detail</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo base_url()?>Registrasi/FormulirRegistrasi/PAUD?act=Tambah" target="_blank" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>PAUD</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo base_url()?>Registrasi/FormulirRegistrasi/SDIQ?act=Tambah" target="_blank" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>SDIQ</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo base_url()?>Registrasi/FormulirRegistrasi/SMP?act=Tambah" target="_blank" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>SMP</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo base_url()?>Registrasi/FormulirRegistrasi/SMA?act=Tambah" target="_blank" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>SMA</p>
                  </a>
                </li>
